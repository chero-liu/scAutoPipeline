...
from scAutoPipeline.__init__ import __VERSION__, ASSAY_LIST
from scAutoPipeline.tools import utils
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="scAutoPipeline for single cell RNA Pipline",
